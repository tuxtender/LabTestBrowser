...
namespace LabTestBrowser.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250328135745_CreateCompleteBloodCount")]
    partial class CreateCompleteBloodCount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LabTestBrowser.Core.CompleteBloodCountAggregate.CompleteBloodCount", b =>
                {
                    ...
                    b.OwnsOne("LabTestBrowser.Core.CompleteBloodCountAggregate.LabTestResult", "Lymphocyte", b1 =>
                        {
                            b1.Property<int>("CompleteBloodCountId")
                                .HasColumnType("INTEGER");
