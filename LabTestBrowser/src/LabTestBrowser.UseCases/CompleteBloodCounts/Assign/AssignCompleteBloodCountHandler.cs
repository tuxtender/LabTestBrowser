...
public class AssignCompleteBloodCountHandler(IRepository<CompleteBloodCount> _repository)
	: ICommandHandler<AssignCompleteBloodCountCommand, Result>
{
	public async Task<Result> Handle(AssignCompleteBloodCountCommand request, CancellationToken cancellationToken)
	{
