...
To update the database use this command from the Web project folder (replace `LabTestBrowser` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../LabTestBrowser.Infrastructure/LabTestBrowser.Infrastructure.csproj -s LabTestBrowser.Web.csproj
```
